 ...
 */
/**
 * Created by morganmonzingo on 12/14/15.
 */

    public class getDemAll extends ArrayAdapter<Book> {
        public Context ctx;
     public getDemAll(Context context, Book[] books) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView bookDescription = (TextView) convertView.findViewById(R.id.homeDescription);
        ...
        bookTitle.setText(book.collectionName);
