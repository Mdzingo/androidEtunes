...
public class theLuckyButton extends AsyncTask<String, Double, Book[]>{
    ...
    protected void onPostExecute(Book[] result){
        ...
        getDemAll adapter = new getDemAll(this.context, result);
        final ListView listview = (ListView)this.parent.findViewById(R.id.bookText);
        Log.d("on Post", "set on click");
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.d("do in Background BS", "In On Item Click");
                Book lilBuk = (Book) listview.getItemAtPosition(position);
